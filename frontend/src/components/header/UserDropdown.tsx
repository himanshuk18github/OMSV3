...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 flex h-11 w-11 items-center justify-center rounded-full bg-brand-600 text-sm font-semibold text-white shadow-sm shadow-brand-600/30">
          {initials}
        </span>
        <span className="mr-1 block max-w-[10rem] truncate font-medium text-theme-sm">
